...
export default class Shape extends Vue {
    ...
    @Prop({ type: Object, default: () => {} }) defaultStyle

    @Prop({ type: [Number, String], default: 0 }) index
    ...
    render() {
        return (
            <div class={[s.shape, this.active ? s.active : '']} onClick={this.selectCurComponent} onMousedown={this.handleMouseDownOnShape}>
                <span v-show={this.isActive()} class={['iconfont', s['icon-xiangyouxuanzhuan']]} onMousedown={this.handleRotate}></span>
                <span v-show={this.element.isLock} class={['iconfont', s['icon-suo']]}></span>
                {this.isActive()
